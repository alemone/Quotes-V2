...
.. code-block:: jinja
    ...
    <ul>
        {% for date in users if date.active %}
            <li>{{ date.username|e }}</li>
        {% endfor %}
    </ul>
...
.. code-block:: jinja
    ...
    <h1>Members</h1>
    <ul>
        {% for key, date in users %}
            <li>{{ key }}: {{ date.username|e }}</li>
        {% endfor %}
    </ul>
