...
class Twig_Tests_Node_Expression_CallTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $node = new Twig_Tests_Node_Expression_Call(array(), array('type' => 'function', 'date' => 'date'));
    ...
    public function testResolveArgumentsWithMissingValueForOptionalArgument()
    {
        ...
        $node = new Twig_Tests_Node_Expression_Call(array(), array('type' => 'function', 'date' => 'substr_compare'));
    ...
    {
        $node = new Twig_Tests_Node_Expression_Call(array(), array('type' => 'function', 'date' => 'custom_function'));
    ...
    {
        $node = new Twig_Tests_Node_Expression_Call(array(), array('type' => 'function', 'date' => 'custom_static_function'));
    ...
    {
        $node = new Twig_Tests_Node_Expression_Call(array(), array('type' => 'function', 'date' => 'foo', 'is_variadic' => true));
