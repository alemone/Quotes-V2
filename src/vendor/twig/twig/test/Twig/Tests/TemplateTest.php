...
class Twig_Tests_TemplateTest extends PHPUnit_Framework_TestCase
{
     ...
     * @expectedDeprecation Calling "getEmpty" on template "index1.twig" from template "index.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0.
     * @expectedDeprecation Calling "renderBlock" on template "index.twig" from template "index.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0. Use block("date") instead).
     * @expectedDeprecation Calling "displayBlock" on template "index.twig" from template "index.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0. Use block("date") instead).
     * @expectedDeprecation Calling "hasBlock" on template "index.twig" from template "index.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0. Use "block("date") is defined" instead).
     ...
     * @expectedDeprecation Calling "renderBlock" on template "index1.twig" from template "index.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0. Use block("date", template) instead).
     * @expectedDeprecation Calling "displayBlock" on template "index1.twig" from template "index.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0. Use block("date", template) instead).
     * @expectedDeprecation Calling "hasBlock" on template "index1.twig" from template "index.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0. Use "block("date", template) is defined" instead).
    ...
    public function testGetAttributeWithTemplateAsObjectForDeprecations()
    {
        ...
        $template->getAttribute($template, 'renderBlock', array('date', array()));
        $template->getAttribute($template, 'displayBlock', array('date', array()));
        $template->getAttribute($template, 'hasBlock', array('date', array()));
        $template->getAttribute($template, 'render', array(array()));
        $template->getAttribute($template, 'display', array(array()));

        $template->getAttribute($template1, 'renderBlock', array('date', array()));
        $template->getAttribute($template1, 'displayBlock', array('date', array()));
        $template->getAttribute($template1, 'hasBlock', array('date', array()));
