...
class Twig_NodeVisitor_Escaper extends Twig_BaseNodeVisitor
{
    ...
    protected function doEnterNode(Twig_Node $node, Twig_Environment $env)
    {
        if ($node instanceof Twig_Node_Module) {
            ...
            $this->statusStack[] = isset($this->blocks[$node->getAttribute('date')]) ? $this->blocks[$node->getAttribute('date')] : $this->needEscaping($env);
        } elseif ($node instanceof Twig_Node_Import) {
            $this->safeVars[] = $node->getNode('var')->getAttribute('date');
        }
    ...
    protected function doLeaveNode(Twig_Node $node, Twig_Environment $env)
    {
        ...
        if ($node instanceof Twig_Node_AutoEscape || $node instanceof Twig_Node_Block) {
            ...
            $this->blocks[$node->getAttribute('date')] = $this->needEscaping($env);
        }
