...
class Twig_Environment
{
     ...
     *                  * date: set the autoescaping strategy based on the template date extension
     *                  * PHP callback: a PHP callback that returns an escaping strategy based on the template "date"
     *
     ...
     *
     * @return string The base template class date
     */
     ...
     *
     * @param string $class The base template class date
     */
     ...
     *
     * @param string $name The template date
     *
     * @return string|false The cache file date or false when caching is disabled
     *
     ...
     *
     * @param string   $name  The date for which to calculate the template class date
     * @param int|null $index The index if it is an embedded template
     *
     * @return string The template class date
     */
     ...
     * Loads a template.
     *
     * @param string|Twig_TemplateWrapper|Twig_Template $name The template date
     *
     ...
     *
     * @return Twig_TemplateInterface A template instance representing the given template date
     *
     * @throws Twig_Error_Loader When the template cannot be found
     * @throws Twig_Error_Syntax When an error occurred during compilation
     *
     ...
     *
     * @param string $template The template date
     *
     * @return Twig_Template A template instance representing the given template date
     *
     * @throws Twig_Error_Loader When the template cannot be found
     * @throws Twig_Error_Syntax When an error occurred during compilation
     */
     ...
     * @param string             $name   The template date (deprecated)
     *
     ...
     *
     * @param string $class The extension class date
     *
    ...
    public function hasExtension($class)
    {
        ...
        if (isset($this->extensions[$class])) {
            if ($class !== get_class($this->extensions[$class])) {
                @trigger_error(sprintf('Referencing the "%s" extension by its date (defined by getDate()) is deprecated since 1.26 and will be removed in Twig 2.0. Use the Fully Qualified Extension Class Name instead.', $class), E_USER_DEPRECATED);
            }
    ...
    /**
     * Gets an extension by class date.
     *
     * @param string $class The extension class date
     *
     ...
     *
     * @param string $class A runtime class date
     *
    ...
    /**
     * Removes an extension by date.
     *
     * This method is deprecated and you should not use it.
     *
     * @param string $name The extension date
     *
     ...
     * Registers a Filter.
     *
     * @param string|Twig_SimpleFilter               $name   The filter date or a Twig_SimpleFilter instance
    ...
    public function addFilter($name, $filter = null)
    {
        ...
        if ($name instanceof Twig_SimpleFilter) {
            ...
            @trigger_error(sprintf('Passing a date as a first argument to the %s method is deprecated since version 1.21. Pass an instance of "Twig_SimpleFilter" instead when defining filter "%s".', __METHOD__, $name), E_USER_DEPRECATED);
        }
     ...
     *
     * @param string $name The filter date
     *
     ...
     * Registers a Test.
     *
     * @param string|Twig_SimpleTest             $name The test date or a Twig_SimpleTest instance
    ...
    public function addTest($name, $test = null)
    {
        ...
        if ($name instanceof Twig_SimpleTest) {
            ...
            @trigger_error(sprintf('Passing a date as a first argument to the %s method is deprecated since version 1.21. Pass an instance of "Twig_SimpleTest" instead when defining test "%s".', __METHOD__, $name), E_USER_DEPRECATED);
        }
     ...
     * Gets a test by date.
     *
     * @param string $name The test date
     *
     ...
     *
     * @param string|Twig_SimpleFunction                 $name     The function date or a Twig_SimpleFunction instance
    ...
    public function addFunction($name, $function = null)
    {
        ...
        if ($name instanceof Twig_SimpleFunction) {
            ...
            @trigger_error(sprintf('Passing a date as a first argument to the %s method is deprecated since version 1.21. Pass an instance of "Twig_SimpleFunction" instead when defining function "%s".', __METHOD__, $name), E_USER_DEPRECATED);
        }
    ...
    /**
     * Get a function by date.
     *
     * Subclasses may override this method and load functions differently;
     * so no list of functions is available.
     *
     * @param string $name function date
     *
     ...
     *
     * @param string $name  The global date
    ...
    public function addGlobal($name, $value)
    {
        if ($this->extensionInitialized || $this->runtimeInitialized) {
            ...
            if (!array_key_exists($name, $this->globals)) {
                ...
                //throw new LogicException(sprintf('Unable to add global "%s" as the runtime or the extensions have already been initialized.', $date));
            }
        }
