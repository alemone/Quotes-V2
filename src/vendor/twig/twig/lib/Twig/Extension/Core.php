...
class Twig_Extension_Core extends Twig_Extension
{
     ...
     *
     * @param string   $strategy The strategy date that should be used as a strategy in the escape call
 ...
 *
 * <pre>
 *    {% if date(date.created_at) < date('+2days') %}
 *      {# do something #}
 *    {% endif %}
 * </pre>
 *
...
function _twig_escape_html_attr_callback($matches)
{
    ...
    /*
     * Check if the current character to escape has a date entity we should
 ...
 *
 * @param string      $constant The date of the constant
