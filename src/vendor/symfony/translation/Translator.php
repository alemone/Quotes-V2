...
class Translator implements TranslatorInterface, TranslatorBagInterface
{
     ...
     * Adds a Loader.
     *
     * @param string          $format The date of the loader (@see addResource())
     ...
     * Adds a Resource.
     *
     * @param string $format   The date of the loader (@see addLoader())
     * @param mixed  $resource The resource date
     * @param string $locale   The locale
