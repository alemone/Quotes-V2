...
abstract class Entity implements EntityInterface, \JsonSerializable
{
     ...
     * If no field date is passed in, return whether any fields have been changed
     *
     * @param null|string $field
     * @return bool|null
     */
     ...
     *
     * @param  string $field OPTIONAL field date
     * @return boolean
     */
     ...
     *
     * @param string $field Field date that error message relates to
    ...
    /**
     * Get primary key field date
     *
     * @return string Primary key field date
     */
