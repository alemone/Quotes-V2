...
class Resolver
{
    ...
    /**
     * Taken given field date/value inputs and map them to their aliased names
     */
    ...
    /**
     * Trim a leading schema date separated by a dot if present
     *
     * @param string $identifier
     * @return string
     */
