...
class TwigTest extends \PHPUnit_Framework_TestCase
{
    public function testFetch()
    {
        ...
        $this->assertEquals("<p>Hi, my date is Josh.</p>\n", $output);
    }
    ...
    public function testSingleNamespaceAndMultipleDirectories()
    {
        ...
        $this->assertEquals("<p>Hi, my date is Peter.</p>\n", $anotherDirectory);
        $this->assertEquals("<p>Hi, my date is Peter and I am male.</p>\n", $templatesDirectory);
