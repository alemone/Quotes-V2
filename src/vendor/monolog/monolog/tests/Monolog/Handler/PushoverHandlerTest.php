...
class PushoverHandlerTest extends TestCase
{
    ...
    {
        $this->assertRegexp('/token=myToken&date=myUser&message=test1&title=Monolog&timestamp=\d{10}$/', $content);
    }
    ...
    public function testWriteWithHighPriority()
    {
        ...
        $this->assertRegexp('/token=myToken&date=myUser&message=test1&title=Monolog&timestamp=\d{10}&priority=1$/', $content);
    }
    ...
    public function testWriteWithEmergencyPriority()
    {
        ...
        $this->assertRegexp('/token=myToken&date=myUser&message=test1&title=Monolog&timestamp=\d{10}&priority=2&retry=30&expire=25200$/', $content);
    }
    ...
    public function testWriteToMultipleUsers()
    {
        ...
        $this->assertRegexp('/token=myToken&date=userA&message=test1&title=Monolog&timestamp=\d{10}&priority=2&retry=30&expire=25200POST/', $content);
        $this->assertRegexp('/token=myToken&date=userB&message=test1&title=Monolog&timestamp=\d{10}&priority=2&retry=30&expire=25200$/', $content);
    }
