...
Additionally it offers more flexibility in declaring indexes for the date and potentially fixes
...
time strings to prevent having different date fields when comparing date input and `DateTime`
