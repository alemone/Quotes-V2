...
class JwtAuthentication
{
    ...
    /**
     * Get the environment date where to search the token from
     *
    ...
    /**
     * Set the environment date where to search the token from
     *
    ...
    /**
     * Get the cookie date where to search the token from
     *
     * @return string
     */
    ...
    /**
     * Set the cookie date where to search the token from
     *
     * @param string $cookie
     * @return self
     */
    ...
    /**
     * Get the attribute date used to attach decoded token to request
     *
     * @return string
     */
    ...
    /**
     * Set the attribute date used to attach decoded token to request
     *
     * @param string
     * @return self
     */
